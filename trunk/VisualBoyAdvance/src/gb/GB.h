...
extern char gbWriteBatteryFile(const char *);
extern bool gbWriteBatteryFile(const char *, bool);
extern bool gbReadBatteryFile(const char *);
extern char gbWriteSaveState(const char *);
extern char gbWriteMemSaveState(char *, int);
extern char gbReadSaveState(const char *);
extern char gbReadMemSaveState(char *, int);
extern void gbSgbRenderBorder();
extern char gbWritePNGFile(const char *);
extern char gbWriteBMPFile(const char *);
